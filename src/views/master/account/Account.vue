...
const createModal = () => {
    ...
    titleModal.value = 'Tambah Akun';
    modalType.value = 'create';
};

const editModal = (data) => { 
    showCreateModal.value = true;
    titleModal.value = 'Edit Akun';
...
<template>
    <div class="mt-2">
        <div class="relative overflow-x-auto">
            ...
            <DataTable v-model:filters="filters" :value="users" resizableColumns columnResizeMode="fit" showGridlines paginator stripedRows :rows="10" :rowsPerPageOptions="[5, 10, 20, 50]" tableStyle="margin-bottom: 10px;"
